 ...
 * @param {string} params.action - Action name (e.g. "ISSUE_CREATED")
 * @param {string} params.entityType - Entity type (e.g. "ISSUE", "COMMENT", "PROJECT")
 * @param {string} params.entityId - Entity ID
 * @param {Object} [params.metadata] - Additional JSON metadata
 * @param {Object} [tx] - Optional Prisma transaction instance
 */
async function logActivity({ userId, action, entityType, entityId, metadata = null }, tx = null) {
  const db = tx || prisma;
